        ...
        <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
            <form action="{{route('user.store')}}" method="post" autocomplete="off">
                ...
                <div class="row g-3">
                    ...
                    <!-- Nombre -->
                    <x-form-element id="name" required="true" label="Nombre" colSize="6"></x-form-element>
                    ...
                    <!-- Email -->
                    <x-form-element id="email" type="email" label="Correo Electrónico"></x-form-element>
                    ...
                    <!-- Roles -->
                    <x-form-element type="select" id="role" label="Rol" required="true" :params="$Roles"></x-form-element>
